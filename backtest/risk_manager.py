...
class RiskManager:
    def __init__(
        ...
        trailing_stop_percent: float = 0.05,  # 跟踪止损百分比
        time_stop_days: int = 20,  # 时间止损天数
        atr_multiplier: float = 2.0  # ATR止损乘数
    ):
        """
        初始化风险管理器
        ...
        self.volatility_manager = VolatilityManager(
            ...
            volatility_threshold=base_risk_per_trade,
            max_position_multiplier=max_position_size * 2
        )
